...
_REPORTKIT_SRC = Path(__file__).resolve().parents[3] / "reportkit" / "src"
...
# Generic capture primitives live in reportkit. Keep the Bot Insights function
# names as compatibility shims because tests and orchestration code import them
